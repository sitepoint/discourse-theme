...
after_initialize do
  ...
  header = <<-EOS.strip_heredoc.chomp
    <noscript>
      <a class="header-link u-button" target="_blank" href="/basetheme?utm_source=community&utm_medium=top-nav" tabindex="2">Themes</a>
...
register_asset "../../../vendor/assets/javascripts/ember-template-compiler.js", :client_side
